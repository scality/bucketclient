...
class RESTClient {
     ...
     * @return {undefined}
     */
    constructor(host, loggingConfig, useHttps, key, cert, ca) {
     ...
     * @return {undefined}
     */
    putObject(bucketName, objName, objVal, reqUids, params, callback,
        reqLogger) {
        const log = reqLogger || this.createLogger(reqUids);
        assert(typeof bucketName === 'string', 'bucketName must be a string');
     ...
     * @return {undefined}
     */
    getObject(bucketName, objName, reqUids, params, callback, reqLogger) {
        const log = reqLogger || this.createLogger(reqUids);
        assert(typeof bucketName === 'string', 'bucketName must be a string');
        assert(typeof objName === 'string', 'objName must be a string');
        let path = `/default/bucket/${bucketName}/`;
     ...
     * @return {undefined}
     */
    getBucketAndObject(bucketName, objName, reqUids, params, callback,
        reqLogger) {
        const log = reqLogger || this.createLogger(reqUids);
        assert(typeof bucketName === 'string', 'bucketName must be a string');
        assert(typeof objName === 'string', 'objName must be a string');
     ...
     * @return {undefined}
     */
    deleteObject(bucketName, objName, reqUids, params, callback, reqLogger) {
        const log = reqLogger || this.createLogger(reqUids);
        assert(typeof bucketName === 'string', 'bucketName must be a string');
        assert(typeof objName === 'string', 'objName must be a string');
        let path = `/default/bucket/${bucketName}/`;
